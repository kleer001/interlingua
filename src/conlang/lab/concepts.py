...
CONCEPTS: tuple[ConceptDef, ...] = (
    ...
    ConceptDef("elephant_trumpeting", "mammal",     ("pawoo", "trumpet"),
    ...
    ConceptDef("cicada_droning",    "insect",       ("buzz", "drone"),
               description="Cicada droning"),
    # ─── marine ─────────────────────────────────────────────────────────
    ConceptDef("whale_calling",     "marine",       ("woooo", "whale"),
               description="Whale calling"),
    ConceptDef("dolphin_clicking",  "marine",       ("eee-eee", "click"),
    ...
    ConceptDef("scream",            "human_nonverbal", ("aaah", "scream"),
               ...
               description="Scream"),
    ConceptDef("heart_beating",     "human_nonverbal", ("ba-dump", "thump"),
    ...
    ConceptDef("kiss",              "human_nonverbal", ("mwah", "smooch"),
               aliases=("kiss",),
               description="Kiss"),
    ConceptDef("stuttering",        "human_nonverbal", ("b-b-b", "uh"),
               aliases=("stuttering",),
