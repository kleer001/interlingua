...
ATTRIBUTE_REGISTRY: dict[str, AttributeBundle] = {
    ...
    # ─── Batch 6: impacts + resonant ───────────────────────────────────
    "dull_strike": AttributeBundle(
        concept="dull_strike",
        attributes=(
            "low-pitched", "percussive", "dampened", "broadband", "sudden-burst",
            "mass-induced", "brief", "sub-resonant", "body-on-ground",
            "blunt-force", "no-resonance", "audible-thud",
            "weight-evoking", "gravity-presence", "mundane-impact-aura",
        ),
        cultural_attributes=(
            "body-hits-floor-cinema-trope-modern-western",
            "sword-falls-from-hand-medieval-trope-european",
            "fainting-spell-victorian-european",
            "drop-mic-modern-american-idiom",
            "dead-weight-idiom-pan-cultural",
            "anvil-cartoon-impact-american",
            "dull-thud-percussion-modern-music",
            "earthquake-fear-pan-cultural",
            "thudding-cinema-soundtrack-modern-western",
            "comedic-pratfall-vaudeville-american",
        ),
    ),
    "falling_strike": AttributeBundle(
        concept="falling_strike",
        attributes=(
            "loud", "broadband", "sudden-burst", "sustained-decay",
            "multi-component", "debris-clatter", "height-induced",
            "mass-from-above", "percussive", "asymmetric", "audible-crash",
            "fragmenting",
            "catastrophe-evoking", "destructive-power", "alarm-trigger",
        ),
        cultural_attributes=(
            "babel-tower-collapse-biblical",
            "jericho-walls-fall-biblical",
            "ragnarok-bifrost-norse",
            "twin-towers-9-11-modern-american",
            "pompeii-volcanic-roman",
            "crash-and-burn-idiom-modern-western",
            "stock-market-crash-1929-american",
            "demolition-controlled-modern-engineering",
            "lightning-and-thunder-pan-cultural",
            "asteroid-impact-extinction-modern-scientific",
        ),
    ),
    "sharp_strike": AttributeBundle(
        concept="sharp_strike",
        attributes=(
            "high-pitched", "brief", "broadband", "sudden-burst", "percussive",
            "audible-snap", "brittle-fracture", "dry-onset", "decisive",
            "transient", "narrow-spectrum", "momentary",
            "decisive-energy", "alert-trigger", "accent-emphasis",
        ),
        cultural_attributes=(
            "snap-the-whip-folk-pan-cultural",
            "finger-snap-attention-pan-cultural",
            "snap-of-fingers-magic-modern-western",
            "whip-crack-cowboy-american",
            "broken-bone-medical-pan-cultural",
            "brittle-twig-snap-pastoral-pan-cultural",
            "snap-judgment-idiom-english",
            "rim-shot-comedy-american",
            "light-bulb-snap-eureka-pan-cultural",
            "kabuki-tsuke-clappers-japanese",
        ),
    ),
    "wet_strike": AttributeBundle(
        concept="wet_strike",
        attributes=(
            "dampened", "broadband", "sudden-burst", "percussive", "viscous",
            "mass-on-surface", "brief", "audible-splat", "liquid-displacement",
            "splatter-pattern", "wet-onset", "asymmetric",
            "messy-presence", "comedic-figure", "viscera-evoking",
        ),
        cultural_attributes=(
            "pie-in-face-vaudeville-american",
            "blood-splatter-cinema-modern-western",
            "paint-balloon-prank-modern-american",
            "comic-book-onomatopoeia-modern-american",
            "watermelon-drop-comedy-pan-cultural",
            "mud-throwing-political-idiom-english",
            "kitchen-disaster-folk-pan-cultural",
            "splat-shoe-on-pavement-pan-cultural",
            "gore-horror-modern-western",
            "jackson-pollock-painting-modern-american",
        ),
    ),
    "ring": AttributeBundle(
        concept="ring",
        attributes=(
            "resonant", "sustained", "harmonic", "metallic", "decaying",
            "sinusoidal", "pure-tone", "audible-ring", "broadband-then-narrowing",
            "melodic-pitch", "vibrating-source", "lingering",
            "sacred-presence", "alert-anticipation", "time-marking-aura",
        ),
        cultural_attributes=(
            "church-bells-christian",
            "liberty-bell-american",
            "tibetan-singing-bowls-buddhist",
            "torah-bells-rimonim-judaic",
            "shinto-suzu-bell-japanese",
            "bell-ringer-quasimodo-french-romantic",
            "dinner-bell-pastoral-pan-cultural",
            "bell-tolls-for-thee-donne-english",
            "jingle-bells-christmas-modern-western",
            "wedding-bells-modern-western",
        ),
    ),
    # ─── Batch 7: mechanical + water + wind + movement ─────────────────
    "tick": AttributeBundle(
        concept="tick",
        attributes=(
            "high-pitched", "brief", "regular-cadence", "percussive", "brittle",
            "dry-onset", "mechanical", "audible-tick", "transient",
            "narrow-spectrum", "momentary", "repetitive",
            "time-marking-presence", "anticipation-building", "mortality-evoking",
        ),
        cultural_attributes=(
            "grandfather-clock-pastoral-european",
            "doomsday-clock-modern-scientific",
            "ticking-time-bomb-cinema-modern-western",
            "tell-tale-heart-poe-american",
            "watchmaker-deism-modern-philosophical",
            "tempus-fugit-roman-latin",
            "white-rabbit-late-alice-english",
            "switzerland-watchmaking-modern-european",
            "biological-clock-modern-medical",
            "tick-tock-onomatopoeia-pan-cultural",
        ),
    ),
    "vroom": AttributeBundle(
        concept="vroom",
        attributes=(
            "low-pitched", "sustained", "rumbling", "mechanical", "throttle-rising",
            "broadband-low", "vibrating-source", "audible-vroom", "motor-driven",
            "varied-pitch", "decay-on-release", "percussive-onset",
            "power-presence", "masculine-aura", "speed-excitement",
        ),
        cultural_attributes=(
            "motorcycle-rebel-modern-western",
            "ferrari-italian-luxury",
            "harley-davidson-american-icon",
            "car-chase-cinema-modern-western",
            "drag-race-american-subculture",
            "jdm-tuner-modern-japanese",
            "mid-life-crisis-modern-western",
            "hot-rod-1950s-american",
            "formula-one-european-sport",
            "ev-revolution-modern-climate",
        ),
    ),
    "water_gurgling": AttributeBundle(
        concept="water_gurgling",
        attributes=(
            "liquid-flowing", "bubbling", "intermittent", "mid-pitch", "gentle",
            "varied-rate", "watery", "vocal-throat-like", "audible-gurgle",
            "sustained", "percolating", "varied-volume",
            "pastoral-presence", "soothing-mood", "contemplative-aura",
        ),
        cultural_attributes=(
            "babbling-brook-pastoral-pan-cultural",
            "fountain-of-youth-european-folkloric",
            "hot-spring-onsen-japanese",
            "ganges-sacred-flow-hindu",
            "water-of-life-celtic",
            "aqua-vitae-european-alchemical",
            "ablution-wudu-islamic",
            "mikveh-purification-judaic",
            "brook-trout-fishing-modern-american",
            "water-cooler-gossip-modern-office-western",
        ),
    ),
    "water_trickling": AttributeBundle(
        concept="water_trickling",
        attributes=(
            "liquid-flowing", "slow", "intermittent", "high-pitch", "gentle",
            "droplet-rhythm", "audible-trickle", "thin-stream", "varied-rate",
            "watery", "percussive-droplet", "sustained-or-bursty",
            "meditative-presence", "slow-time-mood", "drought-anxiety",
        ),
        cultural_attributes=(
            "roman-aqueduct-trickle-classical",
            "dripstone-cave-natural-pan-cultural",
            "clepsydra-water-clock-greek",
            "chinese-water-torture-modern-western-trope",
            "monastic-fountain-medieval-christian",
            "sufi-tear-trickle-mystical-islamic",
            "shishi-odoshi-bamboo-fountain-japanese",
            "drip-irrigation-modern-agriculture",
            "leaky-faucet-modern-domestic",
            "melting-icicle-pastoral-pan-cultural",
        ),
    ),
    "wind_whistling": AttributeBundle(
        concept="wind_whistling",
        attributes=(
            "high-pitched", "sustained", "sinusoidal", "breath-like", "whistling",
            "harmonic", "varied-pitch", "audible-whistle", "narrow-spectrum",
            "atmospheric", "decaying-or-rising", "ghostly",
            "lonely-presence", "eerie-aura", "anticipation-building",
        ),
        cultural_attributes=(
            "aeolian-harp-romantic-european",
            "banshee-wail-celtic",
            "vayu-wind-deity-hindu",
            "north-wind-fable-aesop-greek",
            "yokai-wind-folkloric-japanese",
            "ill-wind-shakespeare-english",
            "jotnar-storm-giants-norse",
            "kamikaze-divine-wind-japanese",
            "dust-bowl-1930s-american",
            "wind-chimes-east-asian",
        ),
    ),
    "flap": AttributeBundle(
        concept="flap",
        attributes=(
            "rhythmic", "broadband", "sudden-onset", "varied-rate",
            "fabric-or-feather", "percussive", "brief-repetitive", "audible-flap",
            "asymmetric", "low-mid-pitch", "atmospheric", "momentary",
            "flight-anticipation", "breeze-presence", "restless-aura",
        ),
        cultural_attributes=(
            "bird-wings-pan-cultural",
            "flag-of-nation-pan-cultural",
            "sails-of-ship-pan-cultural",
            "prayer-flags-tibetan-buddhist",
            "butterfly-effect-modern-scientific",
            "bird-of-paradise-display-papuan",
            "scarecrow-flutter-pastoral-pan-cultural",
            "fan-cooling-east-asian",
            "white-flag-surrender-pan-cultural",
            "eagle-takeoff-american-symbol",
        ),
    ),
    "zoom": AttributeBundle(
        concept="zoom",
        attributes=(
            "doppler-shift", "sustained", "broadband", "swooshing", "fast-onset",
            "decaying-or-rising", "audible-zoom", "rapid-pass-by", "varied-pitch",
            "momentary", "atmospheric", "motion-derived",
            "speed-excitement", "blur-perception", "urgency-evoking",
        ),
        cultural_attributes=(
            "zoom-camera-lens-modern-photography",
            "hot-wheels-toy-modern-american",
            "indianapolis-500-american-racing",
            "sonic-boom-modern-aviation",
            "shinkansen-bullet-train-japanese",
            "comic-book-onomatopoeia-modern-american",
            "fast-and-furious-cinema-modern-american",
            "zoom-meeting-pandemic-modern-western",
            "top-gun-cinema-american-1980s",
            "supersonic-modern-scientific",
        ),
    ),
}
# fmt: on
